      ...
      <div class="button-container" v-if="isLoggedIn">
        ...
        <div class="button-pop">
          ...
          <div class="settings-popup" v-if="showSettingsPopupVisible">
            <ul class="menu">
              <li>
                <font-awesome-icon :icon="['fas', 'bell']" /><router-link to="/">Automatic content</router-link>
                <font-awesome-icon :icon="['fas', 'bell']" /><router-link to="/">Edit your prefrences</router-link>
                <font-awesome-icon :icon="['fas', 'bell']" /><router-link to="/">Automatic content</router-link>
                <font-awesome-icon :icon="['fas', 'bell']" /><router-link to="/">Contact us</router-link>
              </li>
            </ul>
          </div>
        </div>
