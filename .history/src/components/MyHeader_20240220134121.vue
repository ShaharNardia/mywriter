      ...
      <div class="button-container" v-if="isLoggedIn">
        <div class="button-pop">
          ...
          <div class="notification-popup" v-if="showNotificationPopupVisible">
            <ul class="menu">
              <li v-for="(item, index) in notifications" :key="index" :class="item.seen ? '' : 'new-notification'">
        ...
        <div class="button-pop">
          ...
          <div class="settings-popup" v-if="showSettingsPopupVisible">
            <ul class="menu">
              <li>
                <font-awesome-icon :icon="['fas', 'sync']" /><router-link to="/">Set auto generate content job</router-link>
              </li>
              <li>
                <font-awesome-icon :icon="['fas', 'edit']" /><router-link to="/">Edit your prefrences</router-link>
              </li>
              <li>
                <font-awesome-icon :icon="['fas', 'link']" /><router-link to="/">Set webhook</router-link>
              </li>
              <li>
                <font-awesome-icon :icon="['fas', 'envelope']" /><router-link to="/">Contact us</router-link>
              </li>
            </ul>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      username: !localStorage.getItem("user").firstName
        ? "user"
