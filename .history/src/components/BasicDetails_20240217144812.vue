...
export default {
  ...
  data() {
    return {
      ...
      countries: [], // Add this to store the list of all countries
    };
  },
  mounted() {
    // this.dialCode = "972"; // Replace with the dial code for your default country
    const defaultCountry = this.countries.find(country => country.iso2 === this.defaultCountry.toLowerCase());
    if (defaultCountry) {
      this.dialCode = defaultCountry.dialCode;
    }
  },
  methods: {
