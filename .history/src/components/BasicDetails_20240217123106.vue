<template>
  ...
  <div class="flexed">
    ...
    <div>
      ...
      <vue-tel-input class="input" v-model="phoneNumber" @input="updatePhone" :enabledCountryCode="true" :defaultCountry="defaultCountry"></vue-tel-input>
...
export default {
  ...
  data() {
    return {
      ...
      phonePrefix: "",
      phoneNumber: "",
      defaultCountry: 'US', // Set your default country code
      email: "",
      countries: [
