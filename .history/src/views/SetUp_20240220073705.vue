<template>
  <div class="setup-class">
    ...
    <div class="disclaimer">
      <p>
        Disclaimer: The generating content parameters provided by the user are
        solely for personalization purposes and can be changed with every
        generating content request.
      </p>
    </div>
  </div>
</template>
