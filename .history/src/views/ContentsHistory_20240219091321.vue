  ...
  methods: {
    fetchContents() {
      ...
      const eventSource = new EventSource(
        `https://getcontentsbyusertoken-ibnrirhwvq-uc.a.run.app?userToken=${userToken}`
      );

      eventSource.onmessage = (event) => {
        this.contents = JSON.parse(event.data);
    ...
    //   axios.get('https://getcontentsbyusertoken-ibnrirhwvq-uc.a.run.app', {
    //   params: {
    //     userToken: userToken
    //   }
    // }).then((response) => {
