<template>
  <div class="setup-class">
    <div v-if="step === 1">
      ...
      <BasicDetails :userSavedDetails="userSavedDetails" @set-basic-details="handleSetBasicDetails" />
    </div>
    <div v-else-if="step === 2">
      <h2>Step 2 - Your Main Goal</h2>
      <MainGoal :selectedGoalId="userSavedDetails?.goal" @select-goal="selectGoal" />
    </div>
    <div v-else-if="step === 3">
      <h2>Step 3 - Set Your Preferences</h2>
    <SetPrefrences :userSavedDetails="userSavedDetails" @set-prefrences="setPrefrences"/>
    </div>
  </div>
</template>
