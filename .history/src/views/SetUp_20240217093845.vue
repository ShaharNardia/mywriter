<template>
  <div class="setup-class">
    <div v-if="step === 1">
      ...
      <BasicDetails @set-basic-details="setBasicDetails" />
    </div>
    ...
    <MyPrefrences :prefrences="prefrences" @set-prefrences="setPrefrences"/>
    </div>
  </div>
</template>
...
import MyPrefrences from "../components/MyPrefrences.vue";
export default {
  components: {
    BasicDetails,
    MainGoal,
