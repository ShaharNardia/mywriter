<template>
  <div>
    <form @submit="generateContent" class="form">
      ...
      <div class="form-group">
        <label for="useEmojis" class="form-label-checkbox">Use Emojis</label>
        <input type="checkbox" id="useEmojis" v-model="promptParams.useEmojis" class="form-checkbox" />
      </div>
      ...
      <div class="form-group">
        <label for="email" class="form-label">Send to Email:(not mandatory)</label>
