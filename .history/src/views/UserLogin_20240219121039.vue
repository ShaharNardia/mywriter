      ...
      signInWithPopup(auth, provider)
        .then((userCredential) => {
          ...
          axios
            ...
            .then((res) => {
              localStorage.setItem("goalsList", JSON.stringify(res.data.goalsList));
              localStorage.setItem("tonesList", JSON.stringify(res.data.tonesList));
              localStorage.setItem("platformsList", JSON.stringify(res.data.platformsList));
              localStorage.setItem("jobTypesList", JSON.stringify(res.data.jobTypesList));
