...
const seedCollections = async () => {
  try {
    ...
    const platformsListCollection = db.collection("platformList");
       ...
       await Promise.all([
        goalsListCollection.delete(),
        tonesListCollection.delete(),
        platformsListCollection.delete()
      ]);
    ...
    const goalsListData = [
      ...
      },
      {
        id: 2,
        goal: "Drive Sales",
        description: "Generate content aimed at increasing product sales or service sign-ups.",
        icon: ['fas', 'cart-shopping']
      },
      {
        id: 3,
        goal: "Educate Audience",
        description: "Provide informative content that educates the audience on specific topics.",
        icon: ['fas', 'book-open']
      },
      {
        id: 4,
        goal: "Build Brand Awareness",
        description: "Craft content that enhances brand recognition and visibility.",
        icon: ['fas', 'bullhorn']
      },
      {
        id: 5,
        goal: "Improve SEO",
        description: "Focus on content that is optimized to improve search engine rankings.",
      ...
      },
      {
        id: 7,
        goal: "Inspire",
        description: "Inspire the audience with motivational and uplifting content.",
        icon: ['fas', 'lightbulb']
      },
      {
        id: 8,
        goal: "Inform",
        description: "Keep the audience informed with the latest news, updates, or trends.",
        icon: ['fas', 'newspaper']
      },
      {
        id: 9,
        goal: "Connect",
        description: "Create content that fosters a sense of community and connection.",
        icon: ['fas', 'heart']
      },
      {
        id: 10,
      ...
      },
      {
        ...
        description: "Assist students in generating well-researched and structured content for academic assignments.",
    ...
    // Seed platformList collection
    const platformListData = [
      {
        id: 1,
        platform: "Social Media Post",
        description: "Content tailored for social media platforms like Twitter, Facebook, Instagram, etc.",
        icon: ['fab', 'twitter']
      },
      {
        id: 2,
      ...
      },
      {
        ...
        description: "Concise and persuasive descriptions for products on e-commerce sites.",
        icon: ['fas', 'box-open']
      },
      {
        id: 6,
