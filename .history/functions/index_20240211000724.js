...
const generatePrompt = (promptParams) => {
  ...
  let prompt = `Generate a content for ${title}, ${getPurpose(purpose)}, ${useEmoji(useEmojis)} the content should be in language - ${language}. The tone of the content should be ${getTone(tone)}.`;
