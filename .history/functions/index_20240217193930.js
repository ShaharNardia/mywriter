...
exports.getFormSettings = onRequest(async (request, response) => {
  try {
    ...
    if (
      !collectionNames.includes("goalsList") ||
      !collectionNames.includes("tonesList") ||
      !collectionNames.includes("platformsList") ||
      !collectionNames.includes("jobTypesList")
    ) {
...
const seedCollections = async () => {
  try {
    ...
    await Promise.all([
      goalsListCollection.drop(),
      tonesListCollection.drop(),
      platformsListCollection.drop(),
      jobTypesListCollection.drop(),
    ]);
    ...
    await goalsListCollection.insertMany(goalsListData);
    ...
    await tonesListCollection.insertMany(tonesListData);
    ...
    await platformsListCollection.insertMany(platformsListData);
    ...
    await jobTypesListCollection.insertMany(jobTypesListData);
