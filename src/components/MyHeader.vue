          ...
          <div class="settings-popup" v-if="showSettingsPopupVisible">
            <ul class="menu">
              ...
              <li>
                ...
                <router-link @click="closePopup" to="/my-wp"
                  >My wordpress site</router-link
                >
              </li>
              <li>
                <font-awesome-icon :icon="['fas', 'blog']" />
                <router-link @click="closePopup" to="/fetch-wp"
                  >Get content from other wordpress site</router-link
                >
              </li>
              <li>
